...
class ProductLedgersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'in_out' => ['type' => 'string', 'length' => 3, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'amount' => 1,
                'created' => '2021-05-17 14:39:55',
                'modified' => '2021-05-17 14:39:55',
            ],
        ];
        parent::init();
    }
