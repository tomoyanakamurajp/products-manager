...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_code' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'created' => '2021-05-17 14:49:42',
                'modified' => '2021-05-17 14:49:42',
            ],
        ];
        parent::init();
    }
